...
class TableToText:
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            # TODO - 2 rest of the training steps for prefix tuning
    ...
    def predict(self, model, src, num_sequences=1):
        ...
        with torch.no_grad():
            ...
            # TODO - 3 you may want to generate more than one sequence and choose the best one!
...
if __name__ == '__main__':
    ...
    # TODO - 4 default.py always uses a prompt to produce output from the pretrained model
    ...
    if True:
        ...
        model = AutoModelForCausalLM.from_pretrained(opts.basemodel)
        # TODO - 5: if using hf peft library for prefix tuning:
